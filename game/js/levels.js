...
const L3 = {
  ...
  platforms: [
    ...
    // Сегмент 1: x=0–960 (старт + S1, покрывает первый осколок x=642)
    new Platform(   0, 0,  960, 60, '#1a0830'),
    // Сегмент 2: x=1200–1840 (конец S1 + безопасная зона 1)
    new Platform(1200, 0,  640, 60, '#1a0830'),
    // Сегмент 3: x=2200–2960 (середина S2)
    new Platform(2200, 0,  760, 60, '#1a0830'),
    // Сегмент 4: x=3400–4020 (граница S2/S3 — последний потолок)
    new Platform(3400, 0,  620, 60, '#1a0830'),
    // x=4020–5120 — потолка нет: финальный S3 без права на инверсию

    // ── Напольные секции — пол есть в большинстве зон, провалы короткие
    new Platform(   0, 660, 420, 60, '#2a1204'),   // старт (x 0–420)
    new Platform( 580, 660, 300, 60, '#2a1204'),   // S1 середина (x 580–880)
    new Platform(1040, 660, 260, 60, '#2a1204'),   // S1 конец (x 1040–1300)
    new Platform(1400, 660, 440, 60, '#2a1204'),   // безопасная зона 1 (x 1400–1840)
    new Platform(2060, 660, 300, 60, '#2a1204'),   // S2 начало (x 2060–2360)
    new Platform(2620, 660, 260, 60, '#2a1204'),   // S2 конец (x 2620–2880)
    new Platform(3080, 660, 440, 60, '#2a1204'),   // безопасная зона 2 (x 3080–3520)
    new Platform(3760, 660, 260, 60, '#2a1204'),   // S3 начало (x 3760–4020)
    new Platform(4220, 660, 260, 60, '#2a1204'),   // S3 середина (x 4220–4480)
    new Platform(4680, 660, 440, 60, '#2a1204'),   // финал (x 4680–5120)

    // ── Старт (поднятая платформа над полом — трамплин к первой ветке)
...
const LEVELS = [L3, L4, L5, L1, L2, L6];
