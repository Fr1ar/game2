...
const L3 = {
  ...
  platforms: [
    // ── Напольные секции (пол есть только у безопасных зон, в секциях ветвей — провалы)
    new Platform(   0, 660, 420, 60, '#2a1204'),   // старт
    new Platform(1400, 660, 440, 60, '#2a1204'),   // у безопасной зоны 1
    new Platform(3080, 660, 440, 60, '#2a1204'),   // у безопасной зоны 2
    new Platform(4680, 660, 440, 60, '#2a1204'),   // финальная зона
